...
interface BasicRatingType {
  ...
  starCount: number;
  isReadOnly?: boolean;
  showRatingCountFullText?: boolean
}

const BasicRating: FC<BasicRatingType> = (props) => {
  const { starCount = 0, totalReviewCount, isReadOnly = false, showRatingCountFullText = false } = props;
  ...
  return (
    ...
    >
      ...
      />
      <span className={styles.totalReviewCount}>
